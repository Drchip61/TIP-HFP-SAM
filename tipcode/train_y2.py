...
for epoch_num in range(EPOCH):
    ...
    for i_batch,(im1,label0,label1) in enumerate(tqdm.tqdm(train_loader,ncols=60,postfix=show_dict)):  #,edge0,edge1,edge2,edge3
        im1 = im1.cuda().float()
...
#             losses3=0
    ...
    torch.save(model.state_dict(),'samed_1.pth')
